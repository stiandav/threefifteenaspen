...
export const tenants: Tenant[] = [
  {
    ...
    accent: "pine",
    heroImage: "/images/aerial-wagnerpark.jpg",
    heroImageAlt: "Aerial view of Wagner Park and downtown Aspen near the ThreeFifteen building",
    cardImage: "/images/aerial-wagnerpark.jpg",
    cardImageAlt: "Downtown Aspen streets near Wagner Park",
    summary:
  ...
  },
  {
    ...
    body: [
      "The Grove took over the lower level in August 2026 as the building's answer to Aspen's famously expensive real estate for remote workers and small organizations: a members-based co-working space open daily from 7am to 6pm, plus a larger community room that opens to the public for yoga, comedy nights, flamenco dancing, and whatever else the calendar turns up next.",
      "It's designed as a genuine multi-use space rather than a rentable shell — a desk during the day, a lounge for a private gathering at night, a dance floor on a Tuesday. Activations and bookings in The Grove generate proceeds that flow directly back upstairs to fund the Aspen Arts Club's studio program.",
      "For groups looking to book the building for something larger — a launch, a reception, a full evening — The Grove and the courtyard above it are also available as private event space; see the booking page for details.",
    ],
    facts: [
      { label: "Opened", value: "August 1, 2026" },
      { label: "Hours", value: "7am–6pm daily (co-working)" },
      { label: "Proceeds support", value: "Aspen Arts Club" },
    ],
    cta: { label: "Inquire about booking", href: "/book" },
  },
];
