  ...
  return (
    <>
      ...
      <section className="relative flex min-h-screen items-end overflow-hidden bg-black">
        ...
        <div className="relative z-10 mx-auto w-full max-w-6xl px-5 pb-14 pt-32 sm:px-8">
          ...
          <Image
            ...
            height={73}
            priority
            className="mt-3 h-auto w-44 invert sm:w-56"
          />
      ...
      <section className="mx-auto max-w-3xl px-5 py-20 text-center sm:px-8">
        ...
        <p className="mx-auto mt-6 max-w-xl text-base leading-relaxed text-muted">
          ...
          <Link
            href="/about"
            className="whitespace-nowrap font-medium text-black underline decoration-black/30 underline-offset-4 hover:decoration-black"
          >
      ...
      <section className="mx-auto max-w-3xl px-5 py-24 text-center sm:px-8">
        <p className="font-display text-3xl leading-snug text-black sm:text-4xl text-balance">
